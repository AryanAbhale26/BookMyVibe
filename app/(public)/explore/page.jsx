...
const ExplorePage = () => {
  ...
  const { data: featuredEvents, isLoading: LoadingFeatures } = useConvexQuery(
  ...
  // Loading state
  const isLoading = LoadingFeatures || loadingLocal;
    ...
    <>
      <div className="pb-12 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
          Explore feature events, find what&apos;s happening locally, or browse
          events across India
        </p>
      </div>
